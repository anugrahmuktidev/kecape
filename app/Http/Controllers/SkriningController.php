    ...
    public function startTest()
{
    ...
    // Ambil riwayat skrining user
    $riwayatSkrining = RiwayatSkrining::where('user_id', $user->id)->where('jenis_sesi', 'Skrining')
        ->orderBy('tanggal', 'asc')
        ->get();

    return view('user.riwayat-skrining', ['riwayatSkrining' => $riwayatSkrining]);
    }
